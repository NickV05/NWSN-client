            ...
            <div>
              ...
              {isMenuOpen1 && (
                <div className="drop-down">
                  <Link to="/buildCom">Building Shared Community</Link>
                  <Link to="/support">
                  ...
                  <Link to="/disrelief">Disaster Relief</Link>
                  <Link to="/publivcpol">
                    Public Policies Initiatives To End & Prevent Homelessness
                  </Link>
                  <Link to="/resandop">
                    Resources & Funding Opportunities for Members
                  </Link>
                  <Link to="/freegoods">
                    Free/Discounted Good & Services for Members
                  </Link>
                  <Link to="/library">Comprehensive Resource Library</Link>
                  <Link to="https://womensequityproject.org">
            ...
            <div>
              ...
              {isMenuOpen2 && (
                <div className="drop-down">
                  ...
                  <Link to="/partnership">
                    Partner with us To Provide Grants
                  </Link>
