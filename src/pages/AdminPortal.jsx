    ...
    <section className="section">
      {loading ? (
        ...
        <>
          <div>
            {!modal1 ? (
              <button onClick={() => {setModal1(true); setModal2(false)}}>
                Pending Forms ({allForms && allForms.data.filter((obj) => obj.pending === true).length})
              </button>
            ) : (
              <button onClick={() => {setModal1(false); setModal2(false)}}>Go back</button>
            )}
            <button onClick={()=>{setModal1(false); setModal2(true)}}>Previous Forms ({allForms && allForms.data.filter((obj) => obj.pending === false).length})</button>
          </div>
      ...
      {modal2 && <>
            ...
            {allForms.data.filter((obj) => obj.pending === false && obj.type === "VolunteerForm")
              .map((form) => (
                <div key={form.id}>
                  <h3>Volunteer Form</h3>
                  <p>Applicant's Name: {form.firstName} {form.lastName}</p>
              ...
              {allForms.data.filter((obj) => obj.pending === false && obj.type === "PartnerForm")
              .map((form) => (
                <div key={form.id}>
                  <h3>Partner Form</h3>
              ...
              {allForms.data.filter((obj) => obj.pending === false && obj.type === "MemberForm")
              .map((form) => (
                <div key={form.id}>
                  <h3>Member Form</h3>
